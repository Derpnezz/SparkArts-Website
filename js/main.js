...
const teamMembers = [
  ...
  },
  {
    name: 'Cynthia Yu',
    title: 'Creative Lead',
    description: "Hi, I'm Cynthia Yu and I'm the Creative Lead of SparkArts! I hope I can inspire many others to discover their passion for art. Art has been my way of expressing myself since I was in elementary school and I woul dlove to give back that love for art through SparkArts.",
    image: 'cynthia_photo.jpeg',
  },
  {
    name: 'Joshua Vu',
    title: 'Volunteer Engagement Coordinator',
    description: "Hey, I'm Josh and I'm the Volunteer Coordinator at SparkArts. As a kid, I didn't have the big interest in art, but now, I love the endless ways art can be expressed through. I want to help people find their creativity and passion through art early with a fostering community. I hope we can inspire and support everyone!",
    image: 'vujoshia.jpg',
  },
  {
    name: 'Jennifer Zhang',
  ...
  },
  {
    ...
    description: "Hey there! As Program Director of SparkArts, I strive to organize a place where students have a creative outlet to explore and express their passions in the arts.",
